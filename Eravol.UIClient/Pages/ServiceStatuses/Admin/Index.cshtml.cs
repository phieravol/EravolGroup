...
namespace Eravol.UIClient.Pages.ServiceStatuses.Admin
{
    public class IndexModel : PageModel
    {
        ...
        private readonly IClientsRequestService<PagingRequestBase<ServiceStatus>> requestService;
        private readonly IHttpClientFactory clientFactory;

        public IndexModel(IClientsRequestService<PagingRequestBase<ServiceStatus>> requestService, IHttpClientFactory clientFactory)
        {
            this.requestService = requestService;
            this.clientFactory = clientFactory;
        }
        [BindProperty(SupportsGet = true)] public PagingRequestBase<ServiceStatus>? PagingRequest { get; set; }
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            PagingRequest = JsonConvert.DeserializeObject<PagingRequestBase<ServiceStatus>>(dataResponse);
            return Page();
        }
    }
}
