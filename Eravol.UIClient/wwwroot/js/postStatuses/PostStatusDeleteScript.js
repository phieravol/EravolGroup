/**
 * Delete Post Status with confirm dialog
 * */
function confirmDeltePostStatus(postStatusId) {
    var confirmDiaglog = confirm("Are you sure you want to delete this post status?","Delete post status");
    if (confirmDiaglog) {

        const baseUrl = "https://localhost:7259";
        const relativeUrl = "api/Admin/PostStatuses";
